...
__questions = [('Я крепка, как скала, но рушусь от слова. Что я?', ['тишина']),
               ...
               ('У меня бывает борода. Меня можно испортить. Да и ростом бываю не высок. Ниже пояса. Кто я ?', ['шутка', 'Прикол', 'анекдот', 'каламбур', 'шуточка']),
               ('Девять одинаковых кошек в лодке, одна cпрыгнула. Сколько осталось ?', ['ни одной', 'ноль', 'нисколько', 'не осталось']),
               ...
               ('Какой пробкой нельзя заткнуть ни одну бутылку?', ['дорожной', 'автомобильной', 'машинной', 'транспортной']),
...
__first_link = 'Помогите Джейкобу открыть дверь - ответьте на загадку <Имя Загадочника>'
...
__second_success = '''"Милейший, не думайте ничего плохого, я не из полиции, - Блэк старательно успокаивал мужчину в темном фраке, -
мне лишь крайне любопытно узнать: быть может вы знаете что-то о вашем погибшем соседе?"
"Черт, с тобой!" - ответил мужчина и начал свой рассказ о вчерашнем вечере... Так в дневнике Блэка появилась новая улика: '''
...
__third_success = '''Сильно нехотя полицейский согласился пропустить даму. "Вы умеете убеждать, Джейкоб", - с сильным
недовольством он обратился к детективу. "Спасибо, товарищ, я у вас в долгу", - ответил ему Блэк. Джейкоб провел женщину
...
__fourth_part = '''Оставшись в гордом одиночестве, Джейкоб снял шляпу, сильно пропахшую табаком, и достал визитницу
погибшего, которую он тайно забрал с места происшествия. Перебирая кучу бесполезных бумажек, он наткнулся на кое-что
знакомое. "Странно, где-то я уже видел визитку этого банка..." - задумчиво прошептал детектив. И тут он вспомнил:
совсем недавно прогремело дело, в котором коллекторы, связанные с этим банком, серьезно избили молодую девушку.
"Надо навестить моих старых друзей", - решительно произнес Джейкоб и, поймав такси, направился в сторону банка "Сент-Льюис"...
Приехав в главное здание, Блэк сходу встретился с презрительным взглядом главного администратора банка. Он помнил, как много
проблем принес прошлый скандал, и появление очередного детектива не могло сулить ничего хорошего. "Что вам?" - с натянутой
...
# НЕ ЗАБЫТЬ НАПИСАТЬ ДИСКЛЕЙМЕР ПРО КУРЕНИЕ
